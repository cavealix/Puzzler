...
IL_0085:
	...
	}
	{
		...
		ByteU5BU5D_t4116647657* L_25 = (ByteU5BU5D_t4116647657*)SZArrayNew(ByteU5BU5D_t4116647657_il2cpp_TypeInfo_var, (uint32_t)L_24);
		V_1 = L_25;
		...
		ByteU5BU5D_t4116647657* L_28 = __this->get_buffer_0();
		int32_t L_29 = __this->get_bufferPos_3();
		ByteU5BU5D_t4116647657* L_30 = V_1;
		int32_t L_31 = V_2;
		ByteArray_Copy_m353681296(NULL /*static, unused*/, L_28, L_29, L_30, 0, L_31, /*hidden argument*/NULL);
...
IL_00d5:
	{
		ByteU5BU5D_t4116647657* L_33 = __this->get_buffer_0();
		ByteU5BU5D_t4116647657* L_34 = V_1;
		int32_t L_35 = V_2;
		int32_t L_36 = __this->get_bufferSize_1();
		Buffer_BlockCopy_m2884209081(NULL /*static, unused*/, (RuntimeArray *)(RuntimeArray *)L_33, 0, (RuntimeArray *)(RuntimeArray *)L_34, L_35, L_36, /*hidden argument*/NULL);
		int32_t L_37 = V_2;
...
IL_0106:
	...
	{
		ByteU5BU5D_t4116647657* L_43 = __this->get_buffer_0();
		ByteU5BU5D_t4116647657* L_44 = V_1;
		int32_t L_45 = V_2;
		int32_t L_46 = ___size0;
		int32_t L_47 = V_2;
		ByteArray_Copy_m353681296(NULL /*static, unused*/, L_43, 0, L_44, L_45, ((int32_t)il2cpp_codegen_subtract((int32_t)L_46, (int32_t)L_47)), /*hidden argument*/NULL);
...
IL_0130:
	{
		...
		List_1_t1293755103 * L_58 = (List_1_t1293755103 *)il2cpp_codegen_object_new(List_1_t1293755103_il2cpp_TypeInfo_var);
		List_1__ctor_m2588888624(L_58, /*hidden argument*/List_1__ctor_m2588888624_RuntimeMethod_var);
		V_6 = L_58;
		goto IL_01fc;
	}
...
IL_0174:
	{
		int32_t L_59 = V_5;
		ByteU5BU5D_t4116647657* L_60 = __this->get_buffer_0();
		NullCheck(L_60);
		int32_t L_61 = Math_Min_m3468062251(NULL /*static, unused*/, L_59, (((int32_t)((int32_t)(((RuntimeArray *)L_60)->max_length)))), /*hidden argument*/NULL);
		ByteU5BU5D_t4116647657* L_62 = (ByteU5BU5D_t4116647657*)SZArrayNew(ByteU5BU5D_t4116647657_il2cpp_TypeInfo_var, (uint32_t)L_61);
		V_7 = L_62;
		V_8 = 0;
		goto IL_01df;
	}
...
IL_0192:
	{
		Stream_t1273022909 * L_63 = __this->get_input_4();
		if (L_63)
		{
			goto IL_01a3;
		}
...
IL_01a3:
	{
		Stream_t1273022909 * L_64 = __this->get_input_4();
		ByteU5BU5D_t4116647657* L_65 = V_7;
		int32_t L_66 = V_8;
		ByteU5BU5D_t4116647657* L_67 = V_7;
		NullCheck(L_67);
		int32_t L_68 = V_8;
		NullCheck(L_64);
		int32_t L_69 = VirtFuncInvoker3< int32_t, ByteU5BU5D_t4116647657*, int32_t, int32_t >::Invoke(14 /* System.Int32 System.IO.Stream::Read(System.Byte[],System.Int32,System.Int32) */, L_64, L_65, L_66, ((int32_t)il2cpp_codegen_subtract((int32_t)(((int32_t)((int32_t)(((RuntimeArray *)L_67)->max_length)))), (int32_t)L_68)));
		G_B16_0 = L_69;
	}
...
IL_01b9:
	...
	{
		InvalidProtocolBufferException_t2498581859 * L_71 = InvalidProtocolBufferException_TruncatedMessage_m431651349(NULL /*static, unused*/, /*hidden argument*/NULL);
		IL2CPP_RAISE_MANAGED_EXCEPTION(L_71, NULL, CodedInputStream_ReadRawBytes_m2213130119_RuntimeMethod_var);
	}
...
IL_01df:
	...
	}
	{
		...
		List_1_t1293755103 * L_80 = V_6;
		ByteU5BU5D_t4116647657* L_81 = V_7;
		NullCheck(L_80);
		List_1_Add_m403195898(L_80, L_81, /*hidden argument*/List_1_Add_m403195898_RuntimeMethod_var);
	}
...
IL_01fc:
	...
	}
	{
		...
		ByteU5BU5D_t4116647657* L_84 = (ByteU5BU5D_t4116647657*)SZArrayNew(ByteU5BU5D_t4116647657_il2cpp_TypeInfo_var, (uint32_t)L_83);
		V_10 = L_84;
		int32_t L_85 = V_4;
		int32_t L_86 = V_3;
		V_11 = ((int32_t)il2cpp_codegen_subtract((int32_t)L_85, (int32_t)L_86));
		ByteU5BU5D_t4116647657* L_87 = __this->get_buffer_0();
		int32_t L_88 = V_3;
		ByteU5BU5D_t4116647657* L_89 = V_10;
		int32_t L_90 = V_11;
		ByteArray_Copy_m353681296(NULL /*static, unused*/, L_87, L_88, L_89, 0, L_90, /*hidden argument*/NULL);
		List_1_t1293755103 * L_91 = V_6;
		NullCheck(L_91);
		Enumerator_t3182998980  L_92 = List_1_GetEnumerator_m546097336(L_91, /*hidden argument*/List_1_GetEnumerator_m546097336_RuntimeMethod_var);
		V_13 = L_92;
	}
...
IL_0231:
		{
			ByteU5BU5D_t4116647657* L_93 = Enumerator_get_Current_m2689264918((Enumerator_t3182998980 *)(&V_13), /*hidden argument*/Enumerator_get_Current_m2689264918_RuntimeMethod_var);
			V_12 = L_93;
			ByteU5BU5D_t4116647657* L_94 = V_12;
			ByteU5BU5D_t4116647657* L_95 = V_10;
			int32_t L_96 = V_11;
			ByteU5BU5D_t4116647657* L_97 = V_12;
			NullCheck(L_97);
			Buffer_BlockCopy_m2884209081(NULL /*static, unused*/, (RuntimeArray *)(RuntimeArray *)L_94, 0, (RuntimeArray *)(RuntimeArray *)L_95, L_96, (((int32_t)((int32_t)(((RuntimeArray *)L_97)->max_length)))), /*hidden argument*/NULL);
			int32_t L_98 = V_11;
			ByteU5BU5D_t4116647657* L_99 = V_12;
			NullCheck(L_99);
...
IL_0253:
		{
			bool L_100 = Enumerator_MoveNext_m1074123736((Enumerator_t3182998980 *)(&V_13), /*hidden argument*/Enumerator_MoveNext_m1074123736_RuntimeMethod_var);
			if (L_100)
			{
				goto IL_0231;
			}
...
IL_0272:
	{
		ByteU5BU5D_t4116647657* L_101 = V_10;
		return L_101;
	}
}
// System.Boolean Google.ProtocolBuffers.CodedInputStream::SkipField()
...
IL_005f:
	{
		...
		int32_t L_18 = Math_Min_m3468062251(NULL /*static, unused*/, (((int32_t)((int32_t)(((RuntimeArray *)L_16)->max_length)))), L_17, /*hidden argument*/NULL);
		NullCheck(L_14);
		int32_t L_19 = VirtFuncInvoker3< int32_t, ByteU5BU5D_t4116647657*, int32_t, int32_t >::Invoke(14 /* System.Int32 System.IO.Stream::Read(System.Byte[],System.Int32,System.Int32) */, L_14, L_15, 0, L_18);
		V_2 = L_19;
		int32_t L_20 = V_2;
	...
	{
		InvalidProtocolBufferException_t2498581859 * L_21 = InvalidProtocolBufferException_TruncatedMessage_m431651349(NULL /*static, unused*/, /*hidden argument*/NULL);
		IL2CPP_RAISE_MANAGED_EXCEPTION(L_21, NULL, CodedInputStream_SkipImpl_m3770172997_RuntimeMethod_var);
	}
...
extern "C" IL2CPP_METHOD_ATTR CultureInfo_t4157843068 * FrameworkPortability_get_InvariantCulture_m1505314247 (RuntimeObject * __this /* static, unused */, const RuntimeMethod* method)
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
...
extern "C" IL2CPP_METHOD_ATTR void FrameworkPortability__cctor_m4127935117 (RuntimeObject * __this /* static, unused */, const RuntimeMethod* method)
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
